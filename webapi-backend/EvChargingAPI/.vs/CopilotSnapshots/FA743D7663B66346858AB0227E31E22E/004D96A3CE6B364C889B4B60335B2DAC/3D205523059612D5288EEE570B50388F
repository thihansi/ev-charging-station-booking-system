...
namespace EVChargingSystem.Api.Services
{
    public class EVOwnerService : IEVOwnerService
    {
        ...
        public async Task<IEnumerable<EVOwnerDto>> GetAllEVOwners()
        {
            ...
            return owners.Select(owner => new EVOwnerDto
            {
                NIC = owner.NIC,
                Name = owner.Name,
                Email = owner.Email,
        ...
        public async Task<IEnumerable<EVOwnerDto>> GetActiveEVOwners()
        {
            var owners = await _context.EVOwners
                .Find(o => o.IsActive)
                .SortBy(o => o.Name)
        ...
        public async Task<IEnumerable<EVOwnerDto>> GetInactiveEVOwners()
        {
            var owners = await _context.EVOwners
                .Find(o => !o.IsActive)
                .SortBy(o => o.Name)
